...
INSERT INTO `article_accueil` VALUES (1,35,'Le 21','<div>Bienvenue au twenty one 21, votre salon de tatouage et piercing % Douai.<br />,%<br />Situ% en plein centre-ville, notre studio a ouvert ses portes il y a maintenant 3 ans et sest rapidement impos% comme une r%f%rence dans le domaine du tatouage et du piercing dans le Douaisis. Avec plus de 140 avis positifs sur Google, nous avons su cr%er un lieu unique o%c% lart, la cr%ativit% et la convivialit% se rencontrent.</div>'),(2,36,'Un duo de tatoueurs passionn%s','<div>Le salon Le 21 est anim% par Antoine  Tee one , tatoueur sp%cialis% dans le whip-shading, le blackwork et les tatouages aquarelle, et par Hylena  Sowiink, tatoueuse reconnue pour ses cr%ations florales, minimalistes et inspir%es du cabinet de curiosit%s.<br />,%<br />% deux, nous formons une %quipe compl%mentaire : un univers % la fois dark, artistique et d%taill%, et un style fin, d%licat et pr%cieux.</div>'),(3,37,'Tatouage et piercing % Douai','<div>En plus du tatouage, nous proposons %galement un service de piercing professionnel ainsi quune s%lection de bijoux de qualit% % prix attractifs.,%<br />,%<br />Que vous cherchiez un premier piercing discret ou une pi%ce plus originale, vous trouverez forc%ment votre bonheur dans notre collection.</div>'),(4,38,'Un salon inclusif et respectueux','<div>Au twenty one 21, nous croyons que lart du tatouage doit %tre accessible % tous. Nous accueillons avec respect et bienveillance des personnes de toutes origines, orientations</div>');
...
-- Dump completed on 2025-10-09  7:51:14
