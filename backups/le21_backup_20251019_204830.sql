...
CREATE TABLE `article_blog` (
  ...
  `contenu` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `resume` longtext COLLATE utf8mb4_unicode_ci COMMENT 'Résumé court de l’article',
  PRIMARY KEY (`id`),
...
CREATE TABLE `entreprise` (
  ...
  `singleton_key` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'X',
...
--
-- Dumping routines for database 'le_21'
--
...
-- Dump completed on 2025-10-19 18:48:32
